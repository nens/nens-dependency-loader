...
DEPENDENCIES = [
    ...
    Dependency("threedi-modelchecker", "threedi_modelchecker", "==2.18.15", False),
    ...
    Dependency("threedi-mi-utils", "threedi_mi_utils", "==0.1.13", False),
    Dependency("hydxlib", "hydxlib", "==1.7.4", False),
    Dependency("threedi-api-client", "threedi_api_client", "==4.2.2", False),
