...
DEPENDENCIES = [
    ...
    Dependency("threedi-modelchecker", "threedi_modelchecker", "==2.18.25", False),
    ...
    Dependency("hydxlib", "hydxlib", "==1.7.8", False),
    Dependency("threedi-api-client", "threedi_api_client", "==5.0.*", False),
    ...
    Dependency("bridgestyle", "bridgestyle", "==0.1.9", False),
